      ...
      if (this.userData.id_role == 1) {
        this.linkAdmin = {
          ...
          links_juridiction: [
            {
              icon: "groups",
              text: "Catégorie Dossier",
              href: "/admin/CategorieDossier",
            },
            {
              icon: "groups",
              text: "Type Juridiction",
              href: "/admin/TypeJuriduction",
            },
            {
              icon: "groups",
              text: "Categorie Juridiction",
              href: "/admin/CategorieJuriduction",
            },
            {
              icon: "groups",
              text: "Juridiction",
              href: "/admin/Juridiction",
            },
            {
              icon: "groups",
              text: "Affect.Juridiction",
              href: "/admin/AffectationJur",
            },
            {
              icon: "groups",
              text: "Motif Classement",
              href: "/admin/MotifClassement",
            },
            {
              icon: "groups",
              text: "Ville",
          ...
          listDossier: [
            {
              ...
              items: [              
                {
                  text: "Dossiers",
                  href: "/admin/DossierJur", 
                },
                {
                  text: "User-Dossier",
                  href: "/admin/AttributionDossier",
                },
                {
                  text: "User-Dossier",
                  href: "/admin/DossierJur",
          ...
          listArrestation: [
            {
              ...
              items: [              
                {
                  text: "Arrestation",
                  href: "/admin/Arrestation", 
                },
                {
                  text: "Mon Porte-feuil",
                  href: "/admin/Arrestation",
                }
              ],
            },
          ...
          listTribunal: [
            {
              ...
              items: [     
                ...
                {
                  text: "Suivi Tribunal",
                  href: "/admin/SuiviTribunal", 
                },
                {
                  text: "Porte-feuil Tribunal",
                  href: "/admin/Tribunal",
                },
                {
                  text: "Porte-feuil Suivi",
                  href: "/admin/SuiviTribunal",
                }
              ],
            },
