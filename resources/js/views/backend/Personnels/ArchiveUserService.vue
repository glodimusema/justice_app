    ...
    <v-layout>
                                ...
                                <v-flex xs12 sm12 md12 lg12>
                                  <div class="mr-1">
                                    <v-autocomplete label="Selectionnez le Service" prepend-inner-icon="mdi-map"
                                      :rules="[(v) => !!v || 'Ce champ est requis']" :items="serviceList" item-text="name_service"
        ...
        export default {
          ...
          methods: {
            ...
            validate() {
              if (this.$refs.form.validate()) {
                ...
                if (this.edit) {
                  ...
                  this.insertOrUpdate(
                    `${this.apiBaseURL}/insert_archive_user_service`,
            ...
            editData(id) {
              this.editOrFetch(`${this.apiBaseURL}/fetch_single_archive_user_service/${id}`).then(
                ({ data }) => {
            ...
            deleteData(id) {
              this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_archive_user_service/${id}`).then(
                  ({ data }) => {
                    this.showMsg(data.data);
                    this.fetchDataList();
                  }
            ...
            fetchDataList() {
              this.fetch_data(`${this.apiBaseURL}/fetch_archive_user_service?page=`);
            },    
            fetchListUser() {
