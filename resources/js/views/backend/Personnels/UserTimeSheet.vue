                                    ...
                                    <tr v-for="item in fetchData" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <v-menu bottom rounded offset-y transition="scale-transition">
                                                ...
                                                <v-list-item v-if="(item.ateste_projet=='NON' && item.ateste_coordo=='NON' && item.ateste_rh=='NON')" link @click="deleteData(item.id)">
                                                    <v-list-item-icon>
...
export default {
    ...
    methods: {
        ...
        ,
        onPageChange() {
            this.fetch_data(`${this.apiBaseURL}/fetch_perso_timesheet_user/${this.userData.id}?page=`);
        },
