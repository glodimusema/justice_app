                            ...
                            <v-card-text>
                                <v-simple-table>
                                    ...
                                    <v-list dense width="">
                                        ...
                                        <v-list-item link @click="showArchivageByCategorie(item.refService, item.name_service)">
                                          <v-list-item-icon>
...
export default {
    ...
    methods: {
        ...
        fetchDataList() {
            this.fetch_data(`${this.apiBaseURL}/fetch_service_archive_user_by_user/${this.userData.id}?page=`);
        },
        fetchListCategorie() {
