...
function printRapportDetailFacture_Compte_Cash($date1, $date2,$refSousCompte)
{
         ...
         ->join('tagent','tagent.id','=','tfin_entetefacturation.refMedecin')
         ...
         "matricule_agent","noms_agent","sexe_agent","contact_agent","mail_agent",
         "grade_agent","fonction_agent","specialite_agent","refMalade","refTypeMouvement",
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:909px;height:387px;position:relative;">
            ...
            <tr style="vertical-align:top;">
                <td style="width:0px;height:22px;"></td>
                <td></td>
                <td class="cs56F73198" colspan="3" style="width:329px;height:20px;line-height:18px;text-align:left;vertical-align:top;"><nobr>&nbsp;PERIODE&nbsp;:&nbsp;&nbsp;Du&nbsp;&nbsp;'.$date1.'&nbsp;&nbsp;au&nbsp;'.$date2.'</nobr></td>
    ...
    {                                
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:936px;height:412px;position:relative;">
            ...
            <tr style="vertical-align:top;">
                <td style="width:0px;height:22px;"></td>
                <td></td>
                <td class="cs56F73198" colspan="5" style="width:329px;height:20px;line-height:18px;text-align:left;vertical-align:top;"><nobr>&nbsp;PERIODE&nbsp;:&nbsp;&nbsp;Du&nbsp;&nbsp;'.$date1.'&nbsp;&nbsp;au&nbsp;'.$date2.'</nobr></td>
 ...
 //'tconf_banque.nom_mode','=', 'CASH'
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:949px;height:413px;position:relative;">
                ...
                <tr style="vertical-align:top;">
                    <td style="width:0px;height:22px;"></td>
                    <td></td>
                    <td class="cs12FE94AA" colspan="4" style="width:207px;height:22px;line-height:16px;text-align:left;vertical-align:top;"><nobr>Fait&nbsp;&#224;&nbsp;Goma&nbsp;le&nbsp;&nbsp;25/12/2022</nobr></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
    ...
    foreach ($data as $row) 
    {
        ...
        $data8 =   DB::select(
         ...
         $output .='
                ...
                <td class="cs6E02D7D2" colspan="2" style="width:64px;height:22px;line-height:15px;text-align:center;vertical-align:middle;">'.$row->numerocompte.'</td>
