...
use App\Models\Juridiction\{tjur_tribunal};
...
class tjur_tribunalController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        ->select("tjur_tribunal.id",'id_president','id_arrestation','accompagne1','fonction1',
        'accompagne2','fonction2','tjur_tribunal.author','tjur_tribunal.refUser',
        "tjur_tribunal.created_at",
        //ARRESTATION
    ...
    function fetch_tjur_tribunal_2()
    {
         $data = DB::table("tjur_tribunal")
         ...
         , "tjur_affect_juridiction.id_user",
          ...
          ,"tjur_type_juridiction.nom_type_jur", "tjur_categorie_juridiction.nom_categorie_jur")
          ->selectRaw("CONCAT('Plaignant : ',tvente_fournisseur.noms,' - Inculpé : ',tvente_client.noms,' Date Arrestation :',DATE_FORMAT(date_arretation,'%d/%M/%Y'), 'Majustrat Affecté : ',user_juge.name,'President Affecté',user_president.name) as data_jur")
        ->get();
...
// active
    ...
    public function store(Request $request)
    {
     ...
     //'accompagne2','fonction2','author','refUser' tjur_tribunal
        //
        if ($request->id !='') 
        {           
            # code...
            // update 
            $data = tjur_tribunal::where("id", $request->id)->update([
                'id_president'=>  $request->id_president,
                'id_arrestation'=>  $request->id_arrestation,
                'accompagne1'=>  $request->accompagne1,
                'fonction1'=>  $request->fonction1,
                'accompagne2'=>  $request->accompagne2,
                'fonction2'=>  $request->fonction2,
    ...
    {
        $data = tjur_tribunal::where('id', $id)->delete();
